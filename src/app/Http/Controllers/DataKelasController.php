...
public function store(Request $request)
{
    ...
    $validated = $request->validate([
        ...
        'siswa.*.tanggal_absen' => 'required_with:siswa|date', // Tanggal absensi ditambahkan di dalam JSON siswa
    ]);
    ...
    try {
        ...
        foreach ($validated['siswa'] as $siswa) {
            ...
            if (!isset($siswa['tanggal_absen']) || empty($siswa['tanggal_absen'])) {
                throw new \Exception('Setiap siswa harus memiliki tanggal absensi.');
            }
        }
        ...
        $dataKelas = DataKelas::create([
            ...
            'siswa' => json_encode($validated['siswa']), // Simpan siswa dengan tanggal_absen
        ]);
...
public function update(Request $request, $id)
{
    ...
    $validated = $request->validate([
        ...
        'siswa.*.tanggal_absen' => 'sometimes:siswa|date', // Tambahkan validasi untuk tanggal_absen
    ]);
    ...
    try {
        ...
        $updatedSiswa = collect($existingSiswa)->map(function ($siswa) use ($validated) {
            ...
            // Jika ada, perbarui datanya termasuk tanggal_absen
...
public function updateSiswa(Request $request, $id)
{
    ...
    $validated = $request->validate([
        ...
        'siswa.*.jam_absen' => 'sometimes|string|max:10',
        'siswa.*.catatan' => 'sometimes|string|max:255',
        'siswa.*.tanggal_absen' => 'sometimes|date', // Tambahkan validasi tanggal_absen
    ]);
