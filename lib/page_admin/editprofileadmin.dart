        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: _imageFile != null
                          ? FileImage(_imageFile!) // Foto yang dipilih
                          : AssetImage('assets/placeholder.jpg')
                              as ImageProvider, // Placeholder jika tidak ada foto
                    ),
                    Positioned(
                      bottom: 0,
                      right: 0,
              ...
              _buildInputField(controller: nameController, hintText: 'Melissa Peters'),
              SizedBox(height: 20),
              // Input Email
              _buildInputLabel('Email'),
              _buildInputField(controller: emailController, hintText: 'melpeters@gmail.com'),
              SizedBox(height: 20),
              // Input Role
